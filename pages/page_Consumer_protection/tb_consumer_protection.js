	...
	let dt = $('#dt-vertical-scroll-ConsumerProtection').DataTable({
		scrollY: 400,
		paging: true,
	...
	// //call Data ConsumerProtection
	let dt2 = $('#dt-vertical-scroll-OutsideConsumerProtection').DataTable({
		scrollY: 400,
		paging: true,
		"pagingType": "simple_numbers",
		"ajax": {
	...
	let dt3 = $('#dt-vertical-scroll-complaintsExInt').DataTable({
		scrollY: 400,
		paging: true,
		"pagingType": "simple_numbers",
		"ajax": {
	...
	let dt4 = $('#dt-vertical-scroll-complaintsOtherPhones').DataTable({
		scrollY: 400,
		paging: true,
		"pagingType": "simple_numbers",
		"ajax": {
